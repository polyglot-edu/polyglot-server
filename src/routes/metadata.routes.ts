...
router.route("/flow").get(MetadataController.flowMetadata);

router.route("/node").get(MetadataController.nodeMetadata);

router.route("/edge").get(MetadataController.edgeMetadata);
